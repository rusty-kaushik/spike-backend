...
public class BlogServiceController {
	...
	public ResponseEntity<ResponseHandler<BlogDto>> saveBlogWithFile(@ModelAttribute BlogDto blogDto) throws IOException {
		...
		ResponseHandler<BlogDto> response = new ResponseHandler<BlogDto>(saveBlogWithFile, "Blog post successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
...
//		return ResponseEntity<ResponseHandlersaveBlogWithFile, HttpStatus.OK,HttpStatus.OK.value(),"Blog post successfully.")>;
	...
	public  ResponseEntity<ResponseHandler<BlogDto>> updateBlog( @PathVariable UUID blogId, @RequestBody BlogUpdateDto updateDto) {

		ResponseHandler<BlogDto> response = new ResponseHandler<BlogDto>(serviceImpl.updateBlog(updateDto, blogId), "Blog modefy successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
		return ResponseEntity.ok(response);
	}
	...
	public  ResponseEntity<ResponseHandler<BlogDto>> updateLike(@RequestParam UUID blogId, @RequestParam Long totalLikeCount) {
		...
		ResponseHandler<BlogDto> response = new ResponseHandler<BlogDto>(serviceImpl.updateLike(totalLikeCount, blogId), "liked", HttpStatus.ACCEPTED, HttpStatus.ACCEPTED.value(),LocalDateTime.now());
	...
	public  ResponseEntity<ResponseHandler<BlogDto>> updateComment(@RequestParam UUID blogId, @RequestParam Long totalCommentCount) {
		ResponseHandler<BlogDto> response = new ResponseHandler<BlogDto>(serviceImpl.updateComment(totalCommentCount, blogId), "commented", HttpStatus.ACCEPTED, HttpStatus.ACCEPTED.value(),LocalDateTime.now());
	...
	public  ResponseEntity<ResponseHandler<Boolean>> deleteBlog(@PathVariable UUID blogId, @RequestParam String updatedBy) {
		ResponseHandler<Boolean> response =new ResponseHandler<>(serviceImpl.deleteBlog(blogId, updatedBy), "Your blog has been deleted successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
	...
	public ResponseEntity<ResponseHandler<Boolean>>  deleteBlogBytitle(@PathVariable String title, @RequestParam UUID blogId,@RequestParam String updatedBy) {
		ResponseHandler<Boolean> response = new ResponseHandler<>(serviceImpl.deleteBlogByTitle(title, blogId,updatedBy), "Your blog has been deleted successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
		return ResponseEntity.ok(response);
	}
	...
	public  ResponseEntity<ResponseHandler<List<BlogDto>>>  getAllBlog(@RequestParam(defaultValue = "0") int pageNum,
		...
		ResponseHandler<List<BlogDto>> response = new ResponseHandler<>(serviceImpl.getBlog(pageNum,pageSize),  "Data retrieved successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
		return ResponseEntity.ok(response);
	}
	...
	public  ResponseEntity<ResponseHandler<List<BlogDto>>> getBlogsByAutherId(@PathVariable @Valid String userId) {
		ResponseHandler<List<BlogDto>> response = new ResponseHandler<>(serviceImpl.getByAutherID(userId),  "Data retrieved successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
	...
	public  ResponseEntity<ResponseHandler<BlogDto>> getBlogById(@PathVariable(value = "blogId") @Valid UUID blogId) {
		ResponseHandler<BlogDto> response = new ResponseHandler<BlogDto>(serviceImpl.getBlogById(blogId),  "Data retrieved successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
		return ResponseEntity.ok(response);
	}
	...
	public  ResponseEntity<ResponseHandler<List<BlogDto>>> getBlogByTitle(@RequestParam(defaultValue = "0") int pageNum,
		...
		if(!blogTitleWithPage.isEmpty()) {
			ResponseHandler<List<BlogDto>> response = new ResponseHandler<>(blogTitleWithPage, "Data retrieved successfully.", HttpStatus.OK, HttpStatus.OK.value(),LocalDateTime.now());
			return ResponseEntity.ok(response);
		}else {
