...
public class CalenderEventController {
	...
	public ResponseEntity<ResponseHandler<CalenderResponseDto>> createCalenderEvent(@RequestBody CalenderEventDto calenderDto) throws FeignException
	{
		return ResponseEntity.ok(new ResponseHandler<>(calService.saveCalenderEvent(calenderDto), "Data Persisted successfully", HttpStatus.OK, HttpStatus.OK.value()));
				
	}
	
	@GetMapping("get-event-by-date/{date}")
	public ResponseEntity<ResponseHandler<List<CalenderResponseDto>>> getCalenderEventByDate(@PathVariable("date") String date)
	{
	...
	public ResponseEntity<ResponseHandler<List<CalenderResponseDto>>> getCalenderEventByWeek()
	{
	...
	public ResponseEntity<ResponseHandler<List<CalenderResponseDto>>> getCalenderEventByMonth(@PathVariable("year") int year, @PathVariable("month") int month)
	{
	...
	public  ResponseEntity<ResponseHandler<CalenderResponseDto>> updateCalenderEventByEventId(@RequestBody CalenderEventUpdateDto updateDto) throws FeignException
	{
	...
	public ResponseEntity<ResponseHandler<Boolean>> deleteCalenderEventByEventId(@PathVariable("eventId") String eventId, @PathVariable("updatedBy") String updatedBy, @PathVariable("reason") String reason) throws FeignException
	{
